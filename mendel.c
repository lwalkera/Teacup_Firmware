...
void io_init(void) {
	...
	#ifdef STEPPER_GLOBAL_MS1
		WRITE(STEPPER_GLOBAL_MS1, STEPPER_GLOBAL_MS1_VALUE);
		SET_OUTPUT(STEPPER_GLOBAL_MS1);
	#endif
	#ifdef STEPPER_GLOBAL_MS2
		WRITE(STEPPER_GLOBAL_MS2, STEPPER_GLOBAL_MS1_VALUE);
		SET_OUTPUT(STEPPER_GLOBAL_MS2);
	#endif
	WRITE(DIO8,0);
	SET_OUTPUT(DIO8);
